## Load and reshape data for analysis; then print a calculated dataset in a file (meanMeasures.txt)
...
write.table(result.frame, file="meanMeasures.txt", row.names = FALSE)